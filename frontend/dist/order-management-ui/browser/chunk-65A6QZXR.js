...
// src/app/features/configuration/config-panel/config-panel.component.ts
var ConfigPanelComponent = class _ConfigPanelComponent {
  ...
  static \u0275fac = function ConfigPanelComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ConfigPanelComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigPanelComponent, selectors: [["app-config-panel"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 39, vars: 21, consts: [[1, "config-container"], [1, "config-header"], ["mat-icon-button", "", "routerLink", "/", 1, "back-btn", 3, "matTooltip"], [1, "page-icon"], [1, "page-title"], [1, "page-subtitle"], [1, "config-grid"], [1, "config-card"], ["color", "primary"], [1, "appearance-settings"], [1, "fancy-toggle"], ["color", "primary", 3, "change", "checked"], [1, "toggle-label"]], template: function ConfigPanelComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "div", 6)(16, "mat-card", 7)(17, "mat-card-header")(18, "mat-card-title")(19, "mat-icon", 8);
      \u0275\u0275text(20, "palette");
      \u0275\u0275elementEnd();
      \u0275\u0275text(21);
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(23, "mat-card-content")(24, "div", 9)(25, "div", 10)(26, "mat-slide-toggle", 11);
      \u0275\u0275listener("change", function ConfigPanelComponent_Template_mat_slide_toggle_change_26_listener() {
        return ctx.toggleTheme();
      });
      \u0275\u0275elementStart(27, "div", 12)(28, "mat-icon");
      \u0275\u0275text(29);
      \u0275\u0275elementEnd();
      \u0275\u0275text(30);
      \u0275\u0275pipe(31, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(32, "div", 10)(33, "mat-slide-toggle", 11);
      \u0275\u0275listener("change", function ConfigPanelComponent_Template_mat_slide_toggle_change_33_listener() {
        return ctx.toggleLang();
      });
      \u0275\u0275elementStart(34, "div", 12)(35, "mat-icon");
      \u0275\u0275text(36, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275text(37);
      \u0275\u0275pipe(38, "translate");
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("matTooltip", \u0275\u0275pipeBind1(3, 9, "NAV.STOREFRONT"));
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(11, 11, "CONFIG.TITLE"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 13, "CONFIG.SUBTITLE"));
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(22, 15, "CONFIG.APPEARANCE_SECTION"), " ");
      \u0275\u0275advance(5);
      \u0275\u0275property("checked", ctx.isDark());
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.isDark() ? "dark_mode" : "light_mode");
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 17, ctx.isDark() ? "CONFIG.DARK_MODE" : "CONFIG.LIGHT_MODE"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("checked", ctx.isArabic());
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(38, 19, ctx.isArabic() ? "CONFIG.LANG_AR" : "CONFIG.LANG_EN"), " ");
    }
  }, dependencies: [
    CommonModule,
    MatCardModule,
    ...
    MatTooltipModule,
    MatTooltip
  ], styles: ['\n\n.config-container[_ngcontent-%COMP%] {\n  max-width: 1200px;\n  margin: 0 auto;\n  animation: fadeInUp 0.5s cubic-bezier(0.25, 0.8, 0.25, 1) both;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  margin-bottom: 32px;\n  margin-bottom: 40px;\n  text-align: center;\n  justify-content: center;\n  flex-direction: column;\n  position: relative;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .page-icon[_ngcontent-%COMP%] {\n  width: 48px;\n  height: 48px;\n  border-radius: 16px;\n  background:\n    linear-gradient(\n      135deg,\n      #635BFF 0%,\n      #0EA5E9 100%);\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .page-icon[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 24px;\n  width: 24px;\n  height: 24px;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .page-title[_ngcontent-%COMP%] {\n  font-size: 28px;\n  font-weight: 700;\n  letter-spacing: -0.5px;\n  margin: 0;\n  color: var(--color-text-main);\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .page-subtitle[_ngcontent-%COMP%] {\n  margin: 2px 0 0;\n  color: var(--color-text-muted);\n  font-size: 14px;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .back-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  left: 0;\n  top: 0;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .page-icon[_ngcontent-%COMP%] {\n  width: 56px;\n  height: 56px;\n  border-radius: 50%;\n  background:\n    linear-gradient(\n      135deg,\n      #635BFF,\n      #0EA5E9);\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin-bottom: 16px;\n  box-shadow: 0 8px 20px rgba(99, 91, 255, 0.4);\n  animation: pulse-glow 3s infinite;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   .page-icon[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 28px;\n  width: 28px;\n  height: 28px;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  font-size: 28px;\n  margin-bottom: 4px;\n  font-weight: 700;\n  background:\n    linear-gradient(\n      135deg,\n      #635BFF 0%,\n      #0EA5E9 100%);\n  -webkit-background-clip: text;\n  -webkit-text-fill-color: transparent;\n  background-clip: text;\n}\n.config-container[_ngcontent-%COMP%]   .config-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: var(--color-text-muted);\n  font-size: 16px;\n}\n.config-container[_ngcontent-%COMP%]   .config-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 32px;\n  align-items: start;\n}\n@media (max-width: 1024px) {\n  .config-container[_ngcontent-%COMP%]   .config-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr;\n  }\n}\n@media (max-width: 768px) {\n  .config-container[_ngcontent-%COMP%]   .config-grid[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n}\n.config-card[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.7);\n  backdrop-filter: blur(12px);\n  -webkit-backdrop-filter: blur(12px);\n  border: 1px solid rgba(255, 255, 255, 0.18);\n  background: var(--color-surface) !important;\n  border-radius: 16px !important;\n  border: 1px solid var(--color-border);\n  box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.07), 0 2px 4px -2px rgba(0, 0, 0, 0.05);\n  margin-bottom: 32px;\n  overflow: hidden;\n  transition: transform 0.3s ease, box-shadow 0.3s ease;\n}\n.dark-theme[_ngcontent-%COMP%]   .config-card[_ngcontent-%COMP%] {\n  background: rgba(15, 23, 42, 0.8);\n}\n.config-card[_ngcontent-%COMP%]:hover {\n  transform: translateY(-4px);\n  box-shadow: 0 15px 35px rgba(99, 91, 255, 0.1);\n}\n.config-card[_ngcontent-%COMP%]   mat-card-header[_ngcontent-%COMP%] {\n  padding: 24px 32px;\n  background:\n    linear-gradient(\n      90deg,\n      rgba(99, 91, 255, 0.05) 0%,\n      transparent 100%);\n  border-bottom: 1px solid var(--color-border);\n}\n.config-card[_ngcontent-%COMP%]   mat-card-header[_ngcontent-%COMP%]   mat-card-title[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: 600;\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  color: var(--color-primary);\n}\n.config-card[_ngcontent-%COMP%]   mat-card-content[_ngcontent-%COMP%] {\n  padding: 32px;\n  background: transparent;\n}\n.config-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.full-width[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.full-width[_ngcontent-%COMP%]     .mdc-text-field--outlined {\n  border-radius: 10px !important;\n  transition: box-shadow 0.3s ease, border-color 0.3s ease;\n}\n.full-width[_ngcontent-%COMP%]     .mdc-text-field--outlined:hover {\n  box-shadow: inset 0 0 0 1px rgba(99, 91, 255, 0.2);\n}\n.full-width[_ngcontent-%COMP%]     .mdc-text-field--focused {\n  box-shadow: 0 0 0 3px rgba(99, 91, 255, 0.15) !important;\n}\n.fancy-toggle[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n  padding: 16px;\n  border-radius: 10px;\n  background: var(--color-bg);\n  border: 1px solid var(--color-border);\n  transition: all 0.3s ease;\n}\n.fancy-toggle[_ngcontent-%COMP%]:hover {\n  background: rgba(99, 91, 255, 0.05);\n  border-color: var(--color-primary);\n}\n.appearance-settings[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.toggle-label[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.toggle-label[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 20px;\n  width: 20px;\n  height: 20px;\n  color: var(--color-text-muted);\n}\n.button-row[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  gap: 24px;\n  padding-top: 24px;\n  border-top: 1px dashed var(--color-border);\n  margin-top: 16px;\n}\n@media (max-width: 768px) {\n  .button-row[_ngcontent-%COMP%] {\n    flex-direction: column;\n    justify-content: center;\n    gap: 16px;\n  }\n}\n.button-row[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  height: 48px;\n  padding: 0 32px;\n  font-weight: 600;\n  font-size: 15px;\n  border-radius: 24px;\n}\n@media (max-width: 768px) {\n  .button-row[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n}\n.button-row[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  margin-right: 8px;\n}\n.button-row[_ngcontent-%COMP%]   .btn-test[_ngcontent-%COMP%] {\n  border: 2px solid #635BFF;\n  color: #635BFF;\n  background: transparent;\n  transition: all 0.3s ease;\n}\n.button-row[_ngcontent-%COMP%]   .btn-test[_ngcontent-%COMP%]:hover:not([disabled]) {\n  background: rgba(99, 91, 255, 0.05);\n  transform: translateY(-2px);\n}\n.button-row[_ngcontent-%COMP%]   .btn-save[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #635BFF 0%,\n      #0EA5E9 100%) !important;\n  color: white;\n  border: none;\n  position: relative;\n  overflow: hidden;\n  transition: all 0.3s ease;\n  box-shadow: 0 4px 15px rgba(99, 91, 255, 0.3);\n}\n.button-row[_ngcontent-%COMP%]   .btn-save[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  top: -50%;\n  left: -50%;\n  width: 200%;\n  height: 200%;\n  background:\n    linear-gradient(\n      to right,\n      rgba(255, 255, 255, 0) 0%,\n      rgba(255, 255, 255, 0.3) 50%,\n      rgba(255, 255, 255, 0) 100%);\n  transform: rotate(30deg) translate(-100%, -100%);\n  transition: transform 0.5s;\n}\n.button-row[_ngcontent-%COMP%]   .btn-save[_ngcontent-%COMP%]:hover:not([disabled]) {\n  transform: translateY(-2px);\n  box-shadow: 0 8px 25px rgba(99, 91, 255, 0.4);\n}\n.button-row[_ngcontent-%COMP%]   .btn-save[_ngcontent-%COMP%]:hover:not([disabled])::after {\n  transform: rotate(30deg) translate(100%, 100%);\n  transition: transform 0.6s ease-in-out;\n}\n/*# sourceMappingURL=config-panel.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigPanelComponent, { className: "ConfigPanelComponent", filePath: "src\\app\\features\\configuration\\config-panel\\config-panel.component.ts", lineNumber: 29 });
})();
export {
  ConfigPanelComponent
};
//# sourceMappingURL=chunk-65A6QZXR.js.map
